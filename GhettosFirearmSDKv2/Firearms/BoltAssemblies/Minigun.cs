...
public class Minigun : BoltBase
{
    ...
    private void StopRevving()
    {
        ...
        if (loopingMuzzleFlash && firearm.defaultMuzzleFlash && firearm.defaultMuzzleFlash.isPlaying)
        {
    ...
    public override void TryFire()
    {
        ...
        else if (loopingMuzzleFlash && firearm.defaultMuzzleFlash && !firearm.defaultMuzzleFlash.isPlaying)
        {
    ...
    {
        if (!loadedCartridge && firearm.magazineWell.ConsumeRound() is { } c)
        {
            loadedCartridge = c;
